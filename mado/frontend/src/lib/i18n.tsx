...
const dict = {
  ...
  // App Mode
  modeOrchestration: { en: "Orchestration", ja: "オーケストレーション" },
  modeApp: { en: "App", ja: "アプリ" },
  modeSelect: { en: "Select mode", ja: "モード選択" },
  appModeLabel: { en: "App Mode", ja: "アプリモード" },
  orchestrationModeLabel: { en: "Orchestration Mode", ja: "オーケストレーションモード" },
  appTasks: { en: "Tasks", ja: "タスク" },
  appTaskTitle: { en: "Task title", ja: "タスク名" },
  appTaskPrompt: { en: "Task prompt", ja: "タスク指示" },
  appTaskPromptPlaceholder: { en: "Describe what the agent should do...", ja: "エージェントに実行させる内容を入力..." },
  appScheduleManual: { en: "Manual", ja: "手動" },
  appScheduleInterval: { en: "Interval", ja: "定期実行" },
  appScheduleCron: { en: "Cron", ja: "Cron" },
  appIntervalMinutes: { en: "Interval (min)", ja: "間隔（分）" },
  appCronExpr: { en: "Cron expression", ja: "Cron式" },
  appDeadline: { en: "Deadline", ja: "期限" },
  appNoDeadline: { en: "No deadline (perpetual)", ja: "期限なし（継続）" },
  appAddTask: { en: "Add Task", ja: "タスク追加" },
  appRunTask: { en: "Run", ja: "実行" },
  appStopTask: { en: "Stop", ja: "停止" },
  appDeleteTask: { en: "Delete", ja: "削除" },
  appTaskEnabled: { en: "Enabled", ja: "有効" },
  appTaskDisabled: { en: "Disabled", ja: "無効" },
  appHistory: { en: "Execution History", ja: "実行履歴" },
  appNoTasks: { en: "No tasks defined. Add a task to get started.", ja: "タスク未定義。タスクを追加してください。" },
  appNoHistory: { en: "No execution history yet.", ja: "実行履歴なし" },
  appSchedulerStart: { en: "Start Scheduler", ja: "スケジューラ開始" },
  appSchedulerStop: { en: "Stop Scheduler", ja: "スケジューラ停止" },
  appSchedulerRunning: { en: "Scheduler active", ja: "スケジューラ稼働中" },
  appLastRun: { en: "Last run", ja: "最終実行" },
  appNextRun: { en: "Next run", ja: "次回実行" },
  appTaskRunning: { en: "Running", ja: "実行中" },
  appTaskCompleted: { en: "Completed", ja: "完了" },
  appTaskError: { en: "Error", ja: "エラー" },
